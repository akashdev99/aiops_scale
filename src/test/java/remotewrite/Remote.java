...
public final class Remote {
  ...
  public static final class WriteRequest extends com.google.protobuf.GeneratedMessageV3
    ...
    public static final class Builder
      ...
      // Construct using
      // com.cisco.cdo.aiops.shared.prometheus.model.Remote.WriteRequest.newBuilder()
      private Builder() {}
  ...
  public static final class ReadRequest extends com.google.protobuf.GeneratedMessageV3
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return remotewrite.Remote
          ...
          .ensureFieldAccessorsInitialized(
              remotewrite.Remote.ReadRequest.class,
              remotewrite.Remote.ReadRequest.Builder.class);
    }
    ...
    public enum ResponseType implements com.google.protobuf.ProtocolMessageEnum {
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
        return remotewrite.Remote.ReadRequest.getDescriptor()
            .getEnumTypes()
            .get(0);
      }
    ...
    @SuppressWarnings("serial")
    private java.util.List<remotewrite.Remote.Query> queries_;

    /** <code>repeated .prometheus.Query queries = 1;</code> */
    @Override
    public java.util.List<remotewrite.Remote.Query>
        getQueriesList() {
      return queries_;
    }
    ...
    public java.util.List<
            ? extends remotewrite.Remote.QueryOrBuilder>
    ...
    /** <code>repeated .prometheus.Query queries = 1;</code> */
    @Override
    public remotewrite.Remote.Query getQueries(int index) {
      return queries_.get(index);
    }

    /** <code>repeated .prometheus.Query queries = 1;</code> */
    @Override
    public remotewrite.Remote.QueryOrBuilder
    ...
    private static final com.google.protobuf.Internal.ListAdapter.Converter<
            Integer,
            remotewrite.Remote.ReadRequest.ResponseType>
        acceptedResponseTypes_converter_ =
            new com.google.protobuf.Internal.ListAdapter.Converter<
                Integer,
                remotewrite.Remote.ReadRequest
                    .ResponseType>() {
              public remotewrite.Remote.ReadRequest
                      .ResponseType
                  convert(Integer from) {
                remotewrite.Remote.ReadRequest.ResponseType
                    result =
                        remotewrite.Remote.ReadRequest
                            .ResponseType.forNumber(from);
                return result == null
                    ? remotewrite.Remote.ReadRequest
     ...
     */
    @Override
    public remotewrite.Remote.ReadRequest.ResponseType
        getAcceptedResponseTypes(int index) {
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof remotewrite.Remote.ReadRequest)) {
        return super.equals(obj);
      }
      remotewrite.Remote.ReadRequest other =
          (remotewrite.Remote.ReadRequest) obj;
    ...
    public static remotewrite.Remote.ReadRequest parseFrom(
    ...
    public static remotewrite.Remote.ReadRequest
    ...
    public static Builder newBuilder(
        remotewrite.Remote.ReadRequest prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder
        ...
        remotewrite.Remote.ReadRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return remotewrite.Remote
            .internal_static_prometheus_ReadRequest_descriptor;
      }
      ...
      // Construct using com.cisco.cdo.aiops.shared.prometheus.model.Remote.ReadRequest.newBuilder()
      private Builder() {}
      ...
      public remotewrite.Remote.ReadRequest
        ...
        return remotewrite.Remote.ReadRequest
            .getDefaultInstance();
      }

      @Override
      public remotewrite.Remote.ReadRequest build() {
        remotewrite.Remote.ReadRequest result =
            buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
      ...
      @Override
      public remotewrite.Remote.ReadRequest buildPartial() {
        remotewrite.Remote.ReadRequest result =
            new remotewrite.Remote.ReadRequest(this);
        buildPartialRepeatedFields(result);
        if (bitField0_ != 0) {
          buildPartial0(result);
        }
      ...
      @Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof remotewrite.Remote.ReadRequest) {
          return mergeFrom(
              (remotewrite.Remote.ReadRequest) other);
        } else {
          super.mergeFrom(other);
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  remotewrite.Remote.Query m =
                      input.readMessage(
                          remotewrite.Remote.Query.parser(),
                          extensionRegistry);
                  if (queriesBuilder_ == null) {
                    ensureQueriesIsMutable();
                    queries_.add(m);
      ...
      private java.util.List<remotewrite.Remote.Query>
          queries_ = java.util.Collections.emptyList();
        ...
        if (!((bitField0_ & 0x00000001) != 0)) {
          queries_ =
              new java.util.ArrayList<
                  remotewrite.Remote.Query>(queries_);
          bitField0_ |= 0x00000001;
        }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
              remotewrite.Remote.Query,
              remotewrite.Remote.Query.Builder,
              remotewrite.Remote.QueryOrBuilder>
          queriesBuilder_;
      ...
      public Builder setQueries(
          int index, remotewrite.Remote.Query value) {
        if (queriesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setQueries(
          int index,
          remotewrite.Remote.Query.Builder builderForValue) {
        if (queriesBuilder_ == null) {
          ensureQueriesIsMutable();
      ...
      public Builder addQueries(
          remotewrite.Remote.Query value) {
        if (queriesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllQueries(
          Iterable<
                  ? extends remotewrite.Remote.Query>
              values) {
        if (queriesBuilder_ == null) {
          ensureQueriesIsMutable();
      ...
      /** <code>repeated .prometheus.Query queries = 1;</code> */
      public remotewrite.Remote.Query.Builder
      ...
      /** <code>repeated .prometheus.Query queries = 1;</code> */
      public java.util.List<remotewrite.Remote.Query.Builder>
      ...
      public Builder setAcceptedResponseTypes(
          int index,
          remotewrite.Remote.ReadRequest.ResponseType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureAcceptedResponseTypesIsMutable();
      ...
      public Builder addAllAcceptedResponseTypes(
          Iterable<
              ...
              values) {
        ensureAcceptedResponseTypesIsMutable();
        for (remotewrite.Remote.ReadRequest.ResponseType
            value : values) {
          acceptedResponseTypes_.add(value.getNumber());
        }
        onChanged();
    ...
    private static final remotewrite.Remote.ReadRequest
        DEFAULT_INSTANCE;

    static {
      DEFAULT_INSTANCE = new remotewrite.Remote.ReadRequest();
    }
  ...
  public interface ReadResponseOrBuilder
     ...
     */
    java.util.List<remotewrite.Remote.QueryResult>
        getResultsList();
     ...
     * <code>repeated .prometheus.QueryResult results = 1;</code>
     */
    remotewrite.Remote.QueryResult getResults(int index);
     ...
     */
    java.util.List<
            ? extends remotewrite.Remote.QueryResultOrBuilder>
     ...
     * <code>repeated .prometheus.QueryResult results = 1;</code>
     */
    remotewrite.Remote.QueryResultOrBuilder
  ...
  public static final class ReadResponse extends com.google.protobuf.GeneratedMessageV3
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return remotewrite.Remote
          ...
          .ensureFieldAccessorsInitialized(
              remotewrite.Remote.ReadResponse.class,
              remotewrite.Remote.ReadResponse.Builder.class);
    }

    public static final int RESULTS_FIELD_NUMBER = 1;

    @SuppressWarnings("serial")
    private java.util.List<remotewrite.Remote.QueryResult>
        results_;
     ...
     */
    @Override
    public java.util.List<remotewrite.Remote.QueryResult>
        getResultsList() {
      return results_;
    }
     ...
     */
    @Override
    public remotewrite.Remote.QueryResult getResults(
        int index) {
     ...
     */
    @Override
    public remotewrite.Remote.QueryResultOrBuilder
        getResultsOrBuilder(int index) {
      return results_.get(index);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof remotewrite.Remote.ReadResponse)) {
        return super.equals(obj);
      }
      remotewrite.Remote.ReadResponse other =
          (remotewrite.Remote.ReadResponse) obj;
    ...
    public static remotewrite.Remote.ReadResponse parseFrom(
        java.nio.ByteBuffer data) throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static remotewrite.Remote.ReadResponse
        parseDelimitedFrom(java.io.InputStream input) throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
    }
    ...
    public static Builder newBuilder(
        remotewrite.Remote.ReadResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder
        ...
        remotewrite.Remote.ReadResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return remotewrite.Remote
            .internal_static_prometheus_ReadResponse_descriptor;
      }
      ...
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        ...
        return remotewrite.Remote
            ...
            .ensureFieldAccessorsInitialized(
                remotewrite.Remote.ReadResponse.class,
                remotewrite.Remote.ReadResponse.Builder
                    .class);
      }

      // Construct using
      // com.cisco.cdo.aiops.shared.prometheus.model.Remote.ReadResponse.newBuilder()
      private Builder() {}
      ...
      @Override
      public remotewrite.Remote.ReadResponse
          getDefaultInstanceForType() {
        return remotewrite.Remote.ReadResponse
            .getDefaultInstance();
      }

      @Override
      public remotewrite.Remote.ReadResponse build() {
        remotewrite.Remote.ReadResponse result =
            buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
      ...
      @Override
      public remotewrite.Remote.ReadResponse buildPartial() {
        remotewrite.Remote.ReadResponse result =
            new remotewrite.Remote.ReadResponse(this);
        buildPartialRepeatedFields(result);
        if (bitField0_ != 0) {
          buildPartial0(result);
        }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other
            instanceof remotewrite.Remote.ReadResponse) {
          return mergeFrom(
              (remotewrite.Remote.ReadResponse) other);
        } else {
          super.mergeFrom(other);
      ...
      public Builder mergeFrom(
          remotewrite.Remote.ReadResponse other) {
        if (other
            == remotewrite.Remote.ReadResponse
                .getDefaultInstance()) return this;
        if (resultsBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  remotewrite.Remote.QueryResult m =
                      input.readMessage(
                          remotewrite.Remote.QueryResult
                              .parser(),
                          extensionRegistry);
                  if (resultsBuilder_ == null) {
                    ensureResultsIsMutable();
      ...
      private void ensureResultsIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          results_ =
              new java.util.ArrayList<
                  remotewrite.Remote.QueryResult>(results_);
          bitField0_ |= 0x00000001;
        }
      }
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
              remotewrite.Remote.QueryResult,
              remotewrite.Remote.QueryResult.Builder,
              remotewrite.Remote.QueryResultOrBuilder>
          resultsBuilder_;
      ...
      public Builder setResults(
          int index, remotewrite.Remote.QueryResult value) {
        if (resultsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addResults(
          remotewrite.Remote.QueryResult value) {
        if (resultsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllResults(
          Iterable<
                  ? extends remotewrite.Remote.QueryResult>
              values) {
        if (resultsBuilder_ == null) {
          ensureResultsIsMutable();
       ...
       * <code>repeated .prometheus.QueryResult results = 1;</code>
       */
      public remotewrite.Remote.QueryResult.Builder
    ...
    private static final remotewrite.Remote.ReadResponse
        DEFAULT_INSTANCE;

    static {
      DEFAULT_INSTANCE =
          new remotewrite.Remote.ReadResponse();
    }
  ...
  public interface QueryOrBuilder
    ...
    java.util.List<remotewrite.Types.LabelMatcher>
        getMatchersList();

    /** <code>repeated .prometheus.LabelMatcher matchers = 3;</code> */
    remotewrite.Types.LabelMatcher getMatchers(int index);
    ...
    /** <code>repeated .prometheus.LabelMatcher matchers = 3;</code> */
    java.util.List<
            ? extends remotewrite.Types.LabelMatcherOrBuilder>
     ...
     * @return The hints.
     */
    remotewrite.Types.ReadHints getHints();

    /** <code>.prometheus.ReadHints hints = 4;</code> */
    remotewrite.Types.ReadHintsOrBuilder getHintsOrBuilder();
  }
  ...
  public static final class Query extends com.google.protobuf.GeneratedMessageV3
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return remotewrite.Remote
          ...
          .ensureFieldAccessorsInitialized(
              remotewrite.Remote.Query.class,
              remotewrite.Remote.Query.Builder.class);
    }
    ...
    @SuppressWarnings("serial")
    private java.util.List<remotewrite.Types.LabelMatcher>
        matchers_;

    /** <code>repeated .prometheus.LabelMatcher matchers = 3;</code> */
    @Override
    public java.util.List<remotewrite.Types.LabelMatcher>
        getMatchersList() {
      return matchers_;
    }
    ...
    /** <code>repeated .prometheus.LabelMatcher matchers = 3;</code> */
    @Override
    public remotewrite.Types.LabelMatcher getMatchers(
        int index) {
    ...
    /** <code>repeated .prometheus.LabelMatcher matchers = 3;</code> */
    @Override
    public remotewrite.Types.LabelMatcherOrBuilder
        getMatchersOrBuilder(int index) {
      return matchers_.get(index);
    }

    public static final int HINTS_FIELD_NUMBER = 4;
    private remotewrite.Types.ReadHints hints_;
     ...
     */
    @Override
    public remotewrite.Types.ReadHints getHints() {
      return hints_ == null
          ? remotewrite.Types.ReadHints.getDefaultInstance()
          : hints_;
    }

    /** <code>.prometheus.ReadHints hints = 4;</code> */
    @Override
    public remotewrite.Types.ReadHintsOrBuilder
        getHintsOrBuilder() {
      return hints_ == null
          ? remotewrite.Types.ReadHints.getDefaultInstance()
          : hints_;
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof remotewrite.Remote.Query)) {
        return super.equals(obj);
      }
      remotewrite.Remote.Query other =
          (remotewrite.Remote.Query) obj;
    ...
    public static remotewrite.Remote.Query parseFrom(
        java.nio.ByteBuffer data) throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static remotewrite.Remote.Query parseDelimitedFrom(
        java.io.InputStream input) throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
    }
    ...
    public static Builder newBuilder(
        remotewrite.Remote.Query prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder
      ...
      // Construct using com.cisco.cdo.aiops.shared.prometheus.model.Remote.Query.newBuilder()
      private Builder() {}
      ...
      @Override
      public remotewrite.Remote.Query
          getDefaultInstanceForType() {
        return remotewrite.Remote.Query.getDefaultInstance();
      }

      @Override
      public remotewrite.Remote.Query build() {
        remotewrite.Remote.Query result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @Override
      public remotewrite.Remote.Query buildPartial() {
        remotewrite.Remote.Query result =
            new remotewrite.Remote.Query(this);
        buildPartialRepeatedFields(result);
        if (bitField0_ != 0) {
          buildPartial0(result);
        }
      ...
      @Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof remotewrite.Remote.Query) {
          return mergeFrom((remotewrite.Remote.Query) other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(
          remotewrite.Remote.Query other) {
        if (other
            == remotewrite.Remote.Query.getDefaultInstance())
          return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  remotewrite.Types.LabelMatcher m =
                      input.readMessage(
      ...
      private void ensureMatchersIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          matchers_ =
              new java.util.ArrayList<
                  remotewrite.Types.LabelMatcher>(matchers_);
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
              remotewrite.Types.LabelMatcher,
              remotewrite.Types.LabelMatcher.Builder,
              remotewrite.Types.LabelMatcherOrBuilder>
          matchersBuilder_;
      ...
      public Builder setMatchers(
          int index, remotewrite.Types.LabelMatcher value) {
        if (matchersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addMatchers(
          remotewrite.Types.LabelMatcher value) {
        if (matchersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllMatchers(
          Iterable<
                  ? extends remotewrite.Types.LabelMatcher>
              values) {
        if (matchersBuilder_ == null) {
          ensureMatchersIsMutable();
      ...
      /** <code>repeated .prometheus.LabelMatcher matchers = 3;</code> */
      public remotewrite.Types.LabelMatcher.Builder
          getMatchersBuilder(int index) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
              ...
              remotewrite.Types.ReadHints.Builder,
      ...
      public Builder setHints(
          remotewrite.Types.ReadHints value) {
        if (hintsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      /** <code>.prometheus.ReadHints hints = 4;</code> */
      public remotewrite.Types.ReadHints.Builder
          getHintsBuilder() {
        bitField0_ |= 0x00000008;
        onChanged();
    ...
    private static final remotewrite.Remote.Query
        DEFAULT_INSTANCE;

    static {
      DEFAULT_INSTANCE = new remotewrite.Remote.Query();
    }

    public static remotewrite.Remote.Query
        getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface QueryResultOrBuilder
     ...
     */
    java.util.List<remotewrite.Types.TimeSeries>
        getTimeseriesList();
     ...
     * <code>repeated .prometheus.TimeSeries timeseries = 1;</code>
     */
    remotewrite.Types.TimeSeries getTimeseries(int index);
     ...
     */
    java.util.List<
            ? extends remotewrite.Types.TimeSeriesOrBuilder>
  ...
  public static final class QueryResult extends com.google.protobuf.GeneratedMessageV3
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return remotewrite.Remote
          ...
          .ensureFieldAccessorsInitialized(
              remotewrite.Remote.QueryResult.class,
              remotewrite.Remote.QueryResult.Builder.class);
    }

    public static final int TIMESERIES_FIELD_NUMBER = 1;

    @SuppressWarnings("serial")
    private java.util.List<remotewrite.Types.TimeSeries>
        timeseries_;
     ...
     */
    @Override
    public java.util.List<remotewrite.Types.TimeSeries>
        getTimeseriesList() {
      return timeseries_;
    }
     ...
     */
    @Override
    public remotewrite.Types.TimeSeries getTimeseries(
        int index) {
      return timeseries_.get(index);
    }
     ...
     */
    @Override
    public remotewrite.Types.TimeSeriesOrBuilder
        getTimeseriesOrBuilder(int index) {
      return timeseries_.get(index);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof remotewrite.Remote.QueryResult)) {
        return super.equals(obj);
      }
      remotewrite.Remote.QueryResult other =
          (remotewrite.Remote.QueryResult) obj;
    ...
    public static remotewrite.Remote.QueryResult parseFrom(
        java.nio.ByteBuffer data) throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static remotewrite.Remote.QueryResult
        parseDelimitedFrom(java.io.InputStream input) throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
    }
    ...
    public static Builder newBuilder(
        remotewrite.Remote.QueryResult prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder
      ...
      // Construct using com.cisco.cdo.aiops.shared.prometheus.model.Remote.QueryResult.newBuilder()
      private Builder() {}
      ...
      @Override
      public remotewrite.Remote.QueryResult
          getDefaultInstanceForType() {
        return remotewrite.Remote.QueryResult
            .getDefaultInstance();
      }

      @Override
      public remotewrite.Remote.QueryResult build() {
        remotewrite.Remote.QueryResult result =
            buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
      ...
      @Override
      public remotewrite.Remote.QueryResult buildPartial() {
        remotewrite.Remote.QueryResult result =
            new remotewrite.Remote.QueryResult(this);
        buildPartialRepeatedFields(result);
        if (bitField0_ != 0) {
          buildPartial0(result);
        }
      ...
      @Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof remotewrite.Remote.QueryResult) {
          return mergeFrom(
              (remotewrite.Remote.QueryResult) other);
        } else {
          super.mergeFrom(other);
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  remotewrite.Types.TimeSeries m =
                      input.readMessage(
      ...
      private void ensureTimeseriesIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          timeseries_ =
              new java.util.ArrayList<
                  remotewrite.Types.TimeSeries>(timeseries_);
          bitField0_ |= 0x00000001;
        }
      }
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
              remotewrite.Types.TimeSeries,
              remotewrite.Types.TimeSeries.Builder,
              remotewrite.Types.TimeSeriesOrBuilder>
          timeseriesBuilder_;
      ...
      public Builder setTimeseries(
          int index, remotewrite.Types.TimeSeries value) {
        if (timeseriesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addTimeseries(
          remotewrite.Types.TimeSeries value) {
        if (timeseriesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllTimeseries(
          Iterable<
                  ? extends remotewrite.Types.TimeSeries>
              values) {
        if (timeseriesBuilder_ == null) {
          ensureTimeseriesIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(values, timeseries_);
       ...
       * <code>repeated .prometheus.TimeSeries timeseries = 1;</code>
       */
      public remotewrite.Types.TimeSeries.Builder
    ...
    private static final remotewrite.Remote.QueryResult
        DEFAULT_INSTANCE;

    static {
      DEFAULT_INSTANCE = new remotewrite.Remote.QueryResult();
    }
  ...
  public interface ChunkedReadResponseOrBuilder
    ...
    java.util.List<remotewrite.Types.ChunkedSeries>
        getChunkedSeriesList();

    /** <code>repeated .prometheus.ChunkedSeries chunked_series = 1;</code> */
    remotewrite.Types.ChunkedSeries getChunkedSeries(
        int index);
    ...
    /** <code>repeated .prometheus.ChunkedSeries chunked_series = 1;</code> */
    remotewrite.Types.ChunkedSeriesOrBuilder
        getChunkedSeriesOrBuilder(int index);
  ...
  public static final class ChunkedReadResponse extends com.google.protobuf.GeneratedMessageV3
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return remotewrite.Remote
          ...
          .ensureFieldAccessorsInitialized(
              remotewrite.Remote.ChunkedReadResponse.class,
              remotewrite.Remote.ChunkedReadResponse.Builder
                  .class);
    }
    ...
    @SuppressWarnings("serial")
    private java.util.List<remotewrite.Types.ChunkedSeries>
        chunkedSeries_;

    /** <code>repeated .prometheus.ChunkedSeries chunked_series = 1;</code> */
    @Override
    public java.util.List<remotewrite.Types.ChunkedSeries>
        getChunkedSeriesList() {
    ...
    /** <code>repeated .prometheus.ChunkedSeries chunked_series = 1;</code> */
    @Override
    public remotewrite.Types.ChunkedSeries getChunkedSeries(
        int index) {
    ...
    /** <code>repeated .prometheus.ChunkedSeries chunked_series = 1;</code> */
    @Override
    public remotewrite.Types.ChunkedSeriesOrBuilder
        getChunkedSeriesOrBuilder(int index) {
      return chunkedSeries_.get(index);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj
          instanceof
          remotewrite.Remote.ChunkedReadResponse)) {
        return super.equals(obj);
      }
      remotewrite.Remote.ChunkedReadResponse other =
          (remotewrite.Remote.ChunkedReadResponse) obj;
    ...
    public static remotewrite.Remote.ChunkedReadResponse
    ...
    public static Builder newBuilder(
        remotewrite.Remote.ChunkedReadResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder
        ...
        remotewrite.Remote.ChunkedReadResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return remotewrite.Remote
            .internal_static_prometheus_ChunkedReadResponse_descriptor;
      }
      ...
      // Construct using
      // com.cisco.cdo.aiops.shared.prometheus.model.Remote.ChunkedReadResponse.newBuilder()
      private Builder() {}
      ...
      @Override
      public remotewrite.Remote.ChunkedReadResponse
          getDefaultInstanceForType() {
        return remotewrite.Remote.ChunkedReadResponse
            .getDefaultInstance();
      }

      @Override
      public remotewrite.Remote.ChunkedReadResponse build() {
        remotewrite.Remote.ChunkedReadResponse result =
            buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
      ...
      public remotewrite.Remote.ChunkedReadResponse
          buildPartial() {
        remotewrite.Remote.ChunkedReadResponse result =
            new remotewrite.Remote.ChunkedReadResponse(this);
        buildPartialRepeatedFields(result);
        if (bitField0_ != 0) {
          buildPartial0(result);
        }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  remotewrite.Types.ChunkedSeries m =
                      input.readMessage(
      ...
      public Builder setChunkedSeries(
          int index, remotewrite.Types.ChunkedSeries value) {
        if (chunkedSeriesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addChunkedSeries(
          remotewrite.Types.ChunkedSeries value) {
        if (chunkedSeriesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllChunkedSeries(
          Iterable<
                  ? extends remotewrite.Types.ChunkedSeries>
              values) {
        if (chunkedSeriesBuilder_ == null) {
          ensureChunkedSeriesIsMutable();
      ...
      /** <code>repeated .prometheus.ChunkedSeries chunked_series = 1;</code> */
      public remotewrite.Types.ChunkedSeries.Builder
          getChunkedSeriesBuilder(int index) {
      ...
      /** <code>repeated .prometheus.ChunkedSeries chunked_series = 1;</code> */
      public remotewrite.Types.ChunkedSeries.Builder
          addChunkedSeriesBuilder(int index) {
        return getChunkedSeriesFieldBuilder()
            .addBuilder(
                index,
                remotewrite.Types.ChunkedSeries
    ...
    private static final remotewrite.Remote
            .ChunkedReadResponse
        DEFAULT_INSTANCE;

    static {
      DEFAULT_INSTANCE =
          new remotewrite.Remote.ChunkedReadResponse();
    }
  ...
  static {
    String[] descriptorData = {
      "\n\014remote.proto\022\nprometheus\032\013types.proto\032"
          ...
          + "kedSeries\022\023\n\013query_index\030\002 \001(\003B5\n+com.ci"
          + "sco.cdo.aiops.shared.prometheus.modelZ\006p"
          + "rompbb\006proto3"
    };
    descriptor =
        com.google.protobuf.Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(
            ...
            new com.google.protobuf.Descriptors.FileDescriptor[] {
              remotewrite.Types.getDescriptor(),
