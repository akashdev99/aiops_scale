...
public final class GoGoProtos {
  ...
  public static void registerAllExtensions(com.google.protobuf.ExtensionRegistryLite registry) {
    registry.add(remotewrite.GoGoProtos.goprotoEnumPrefix);
    registry.add(remotewrite.GoGoProtos.goprotoEnumStringer);
    registry.add(remotewrite.GoGoProtos.enumStringer);
    registry.add(remotewrite.GoGoProtos.enumCustomname);
    registry.add(remotewrite.GoGoProtos.enumdecl);
    registry.add(remotewrite.GoGoProtos.enumvalueCustomname);
    registry.add(remotewrite.GoGoProtos.goprotoGettersAll);
    registry.add(remotewrite.GoGoProtos.goprotoEnumPrefixAll);
    registry.add(remotewrite.GoGoProtos.goprotoStringerAll);
    registry.add(remotewrite.GoGoProtos.verboseEqualAll);
    registry.add(remotewrite.GoGoProtos.faceAll);
    registry.add(remotewrite.GoGoProtos.gostringAll);
    registry.add(remotewrite.GoGoProtos.populateAll);
    registry.add(remotewrite.GoGoProtos.stringerAll);
    registry.add(remotewrite.GoGoProtos.onlyoneAll);
    registry.add(remotewrite.GoGoProtos.equalAll);
    registry.add(remotewrite.GoGoProtos.descriptionAll);
    registry.add(remotewrite.GoGoProtos.testgenAll);
    registry.add(remotewrite.GoGoProtos.benchgenAll);
    registry.add(remotewrite.GoGoProtos.marshalerAll);
    registry.add(remotewrite.GoGoProtos.unmarshalerAll);
    registry.add(remotewrite.GoGoProtos.stableMarshalerAll);
    registry.add(remotewrite.GoGoProtos.sizerAll);
    registry.add(
        remotewrite.GoGoProtos.goprotoEnumStringerAll);
    registry.add(remotewrite.GoGoProtos.enumStringerAll);
    registry.add(remotewrite.GoGoProtos.unsafeMarshalerAll);
    registry.add(remotewrite.GoGoProtos.unsafeUnmarshalerAll);
    registry.add(
        remotewrite.GoGoProtos.goprotoExtensionsMapAll);
    registry.add(
        remotewrite.GoGoProtos.goprotoUnrecognizedAll);
    registry.add(remotewrite.GoGoProtos.gogoprotoImport);
    registry.add(remotewrite.GoGoProtos.protosizerAll);
    registry.add(remotewrite.GoGoProtos.compareAll);
    registry.add(remotewrite.GoGoProtos.typedeclAll);
    registry.add(remotewrite.GoGoProtos.enumdeclAll);
    registry.add(remotewrite.GoGoProtos.goprotoRegistration);
    registry.add(remotewrite.GoGoProtos.messagenameAll);
    registry.add(remotewrite.GoGoProtos.goprotoSizecacheAll);
    registry.add(remotewrite.GoGoProtos.goprotoUnkeyedAll);
    registry.add(remotewrite.GoGoProtos.goprotoGetters);
    registry.add(remotewrite.GoGoProtos.goprotoStringer);
    registry.add(remotewrite.GoGoProtos.verboseEqual);
    registry.add(remotewrite.GoGoProtos.face);
    registry.add(remotewrite.GoGoProtos.gostring);
    registry.add(remotewrite.GoGoProtos.populate);
    registry.add(remotewrite.GoGoProtos.stringer);
    registry.add(remotewrite.GoGoProtos.onlyone);
    registry.add(remotewrite.GoGoProtos.equal);
    registry.add(remotewrite.GoGoProtos.description);
    registry.add(remotewrite.GoGoProtos.testgen);
    registry.add(remotewrite.GoGoProtos.benchgen);
    registry.add(remotewrite.GoGoProtos.marshaler);
    registry.add(remotewrite.GoGoProtos.unmarshaler);
    registry.add(remotewrite.GoGoProtos.stableMarshaler);
    registry.add(remotewrite.GoGoProtos.sizer);
    registry.add(remotewrite.GoGoProtos.unsafeMarshaler);
    registry.add(remotewrite.GoGoProtos.unsafeUnmarshaler);
    registry.add(remotewrite.GoGoProtos.goprotoExtensionsMap);
    registry.add(remotewrite.GoGoProtos.goprotoUnrecognized);
    registry.add(remotewrite.GoGoProtos.protosizer);
    registry.add(remotewrite.GoGoProtos.compare);
    registry.add(remotewrite.GoGoProtos.typedecl);
    registry.add(remotewrite.GoGoProtos.messagename);
    registry.add(remotewrite.GoGoProtos.goprotoSizecache);
    registry.add(remotewrite.GoGoProtos.goprotoUnkeyed);
    registry.add(remotewrite.GoGoProtos.nullable);
    registry.add(remotewrite.GoGoProtos.embed);
    registry.add(remotewrite.GoGoProtos.customtype);
    registry.add(remotewrite.GoGoProtos.customname);
    registry.add(remotewrite.GoGoProtos.jsontag);
    registry.add(remotewrite.GoGoProtos.moretags);
    registry.add(remotewrite.GoGoProtos.casttype);
    registry.add(remotewrite.GoGoProtos.castkey);
    registry.add(remotewrite.GoGoProtos.castvalue);
    registry.add(remotewrite.GoGoProtos.stdtime);
    registry.add(remotewrite.GoGoProtos.stdduration);
    registry.add(remotewrite.GoGoProtos.wktpointer);
  }
  ...
  static {
    String[] descriptorData = {
      "\n\ngogo.proto\022\tgogoproto\032 google/protobuf"
          ...
          + "otobuf.FieldOptions\030\364\373\003 \001(\010B]\n+com.cisco"
          + ".cdo.aiops.shared.prometheus.modelB\nGoGo"
